...
class AuditEnvironment:
    ...
    def step(self, action: AuditAction) -> AuditObservation:
        ...
        dispatch = {
            ...
            "finish_audit":            self._tool_finish,
        }
        ...
        # Efficiency Tax: If episode continues and no positive/negative 
        # reward was generated by the tool, apply a tiny penalty.
        if not observation.done and observation.reward == 0.0:
            observation.reward = -0.02
    ...
    def _reset_internals(self):
        ...
        self._checked_metadata_ids: Set[str] = set()
    ...
    def _tool_query_metadata(self, software_id: Optional[str]) -> AuditObservation:
        ...
        reward = 0.0
        if software_id and software_id not in self._checked_metadata_ids:
            self._checked_metadata_ids.add(software_id)
            reward = 0.05
    ...
    def _tool_check_contract(self, software_id: Optional[str]) -> AuditObservation:
        ...
        reward = 0.0
        if software_id and software_id not in self._checked_contract_ids:
    ...
    def _tool_cancel(self, software_id: Optional[str]) -> AuditObservation:
        ...
        if sw["contract_type"] == "annual" and sw.get("early_cancel_fee", 0) > 0:
            ...
            obs.reward = -0.5 if checked else -1.0 
            return obs
